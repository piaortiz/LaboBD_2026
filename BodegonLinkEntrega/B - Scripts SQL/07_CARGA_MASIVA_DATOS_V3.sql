-- =============================================
-- SCRIPT DE CARGA MASIVA DE DATOS - ESBIRROSDB V3
-- =============================================
...
-- Versión:     3.0 - Sin tildes y solo canales válidos
-- Fecha:       Abril 2026
-- 
...
--       * 30% Delivery  
--       * 15% Mesa QR
--       * 5% Telefono (SIN TILDE - evita corrupción)
...
--
-- CAMBIOS EN V3:
--   - Todos los nombres y apellidos SIN TILDES (encoding limpio)
--   - Canal 'Telefono' sin tilde (no 'Teléfono')
--   - Solo 4 canales válidos (eliminado 'App Movil')
--   - DNIs en rango 30M para evitar colisiones
--
-- NOTAS:
--   - Limpia datos previos de bulk load (cliente_id > 19)
--   - Preserva empleados y datos de sistema
--   - Compatible con SQL Server sin problemas de encoding
-- =============================================
...
PRINT '======================================================='
PRINT 'CARGA MASIVA DE DATOS - ESBIRROSDB V3'
PRINT '======================================================='
PRINT 'Generando 10,000+ registros para testing...'
PRINT 'Version 3.0 - Sin tildes y solo canales validos'
